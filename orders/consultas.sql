...
--
CREATE TABLE "orders_categoria" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "categorias" varchar(30) NOT NULL);
--
-- Create model DetallePedido
--
CREATE TABLE "orders_detallepedido" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "cantidadPlatillos" integer NOT NULL, "precioPlatillos" real NOT NULL, "estado" bool NOT NULL);
--
-- Create model Extra
--
...
-- Create model Pedido
--
CREATE TABLE "orders_pedido" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "descripcion" varchar(50) NOT NULL, "total" real NOT NULL, "fecha" datetime NOT NULL, "cliente_id" integer NOT NULL REFERENCES "auth_user" ("id") DEFERRABLE INITIALLY DEFERRED);
--
...
--
ALTER TABLE "orders_detallepedido" RENAME TO "orders_detallepedido__old";
CREATE TABLE "orders_detallepedido" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "cantidadPlatillos" integer NOT NULL, "precioPlatillos" real NOT NULL, "estado" bool NOT NULL, "pedido_id" integer NOT NULL REFERENCES "orders_pedido" ("id") DEFERRABLE INITIALLY DEFERRED, "platillo_id" integer NOT NULL REFERENCES "orders_platillo" ("id") DEFERRABLE INITIALLY DEFERRED);
INSERT INTO "orders_detallepedido" ("id", "cantidadPlatillos", "precioPlatillos", "estado", "pedido_id", "platillo_id") SELECT "id", "cantidadPlatillos", "precioPlatillos", "estado", "pedido_id", NULL FROM "orders_detallepedido__old";
DROP TABLE "orders_detallepedido__old";
CREATE INDEX "orders_detallepedido_pedido_id_64edb50c" ON "orders_detallepedido" ("pedido_id");
